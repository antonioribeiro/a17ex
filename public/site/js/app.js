/******/ ;(function(modules) {
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                function jBoxWrapper(jQuery) {
                    var jBox = function jBox(type, options) {
                        ...
                        this.options = {
                            ...
                            // AJAX
                            ajax: {
                                // Setting an URL will make an AJAX request when jBox opens. Optional you can add any jQuery AJAX option (http://api.jquery.com/jquery.ajax/)
                            ...
                            attributes: {
                                // Note that attributes can only be 'left' or 'right' when using numbers for position, e.g. {x: 300, y: 20}
                        ...
                        this.options = jQuery.extend(
                            true,
                            this.options,
                            this._pluginOptions[type]
                                ? this._pluginOptions[type]
                                : jBox._pluginOptions[type],
                            options,
                        )
                        ...
                        this._fireEvent = function(event, pass) {
                            this.options['_' + event] &&
                                this.options['_' + event].bind(this)(pass)
                            this.options[event] &&
                        ...
                        this.options.id === null &&
                            (this.options.id = 'jBox' + jBox._getUniqueID())
                        this.id = this.options.id

                        // Correct impossible options
                        ;((this.options.position.x == 'center' &&
                            this.options.outside == 'x') ||
                            (this.options.position.y == 'center' &&
                                this.options.outside == 'y')) &&
                            (this.options.outside = null)
                        this.options.pointTo == 'target' &&
                            (!this.options.outside ||
                                this.options.outside == 'xy') &&
                            (this.options.pointer = false)

                        // Correct multiple choice options

                        jQuery.type(this.options.offset) != 'object'
                            ? (this.options.offset = {
                        ...
                        jQuery.type(this.options.adjustDistance) != 'object'
                        ...
                        this.outside =
                            this.options.outside && this.options.outside != 'xy'
                        ...
                        this._setTitleWidth = function() {
                            ...
                            if (
                                !this.titleContainer ||
                                (this.content[0].style.width == 'auto' &&
                        ...
                        this._draggable = function() {
                            ...
                            var handle =
                                this.options.draggable == 'title'
                                    ? this.titleContainer
                                    : this.options.draggable instanceof jQuery
                                    ? this.options.draggable
                                    : jQuery.type(this.options.draggable) ==
                                      'string'
                                    ? jQuery(this.options.draggable)
                                    : this.wrapper

                            // Abort if no handle or if draggable was set already
                            if (
                                !handle ||
                                !(handle instanceof jQuery) ||
                                !handle.length ||
                                handle.data('jBox-draggable')
                            )
                                return false
                            ...
                            handle
                                ...
                                .data('jBox-draggable', true)
                                .on(
                                    'touchstart mousedown',
                                    function(ev) {
                                        if (
                                            ev.button == 2 ||
                                            jQuery(ev.target).hasClass(
                                                'jBox-noDrag',
                                            ) ||
                            ...
                            // Get highest z-index
                            if (!this.trueModal) {
                                jBox.zIndexMaxDragover = !jBox.zIndexMaxDragover
                                    ? this.options.zIndex
                                    : Math.max(
                                          jBox.zIndexMaxDragover,
                                          this.options.zIndex,
                        ...
                        this._create = function() {
                            ...
                            if (this.options.closeButton) {
                                ...
                                this.closeButton = jQuery(
                                    ...
                                    .append(closeButtonSVG)

                                // Add close button to jBox container
                                if (
                                    this.options.closeButton == 'box' ||
                            ...
                            if (this.options.pointer) {
                                ...
                                if (
                                    ...
                                    split[1] &&
                                        (this.pointer.offset = parseInt(
                                            split[1],
                                        ))
                                }
                                this.pointer.alignAttribute =
                                    this.pointer.xy == 'x'
                                        ? this.pointer.align == 'bottom'
                                            ? 'bottom'
                                            : 'top'
                                        : this.pointer.align == 'right'
                                        ? 'right'
                                        : 'left'
                                ...
                                this.pointer.element.css(
                                    this.pointer.xy == 'x' ? 'width' : 'height',
                                    parseInt(
                                        this.pointer.dimensions[
                                            this.pointer.xy
                                        ],
                        ...
                        this._detachEvents = function() {
                            ...
                            ;(this.options.closeOnClick === true ||
                                this.options.closeOnClick == 'body') &&
                                jQuery(document).off('click.jBox-' + this.id)
                            ...
                            // Mousemove events
                            this.options.target == 'mouse' &&
                                jQuery('body').off('mousemove.jBox-' + this.id)
                        }
                        ...
                        this._showOverlay = function() {
                            ...
                            if (!this.overlay) {
                                ...
                                ;(this.options.closeButton == 'overlay' ||
                                    this.options.closeButton === true) &&
                                    this.overlay.append(this.closeButton)

                                // Add closeOnClick: 'overlay' events
                                this.options.closeOnClick == 'overlay' &&
                                    this.overlay.on(
                                        'click',
                                        function() {
                                            this.close({ ignoreDelay: true })
                        ...
                        this._generateAnimationCSS = function() {
                            ...
                            jQuery.type(this.options.animation) != 'object' &&
                            ...
                            jQuery.each(['pulse', 'tada'], function(
                                index,
                                item,
                            ) {
                                animations[item + 'Open'] = animations[
                                    item + 'Close'
                                ] = animations[item]
                            })
                            ...
                            var generateKeyframeCSS = function(ev, position) {
                                ...
                                keyframe_css =
                                    ...
                                    this.id +
                                    '-animation-' +
                                    this.options.animation[ev] +
                                    '-' +
                                    ev +
                                    (position ? '-' + position : '') +
                                    ' {'
                                jQuery.each(
                                    animations[this.options.animation[ev]].css,
                                    function(index, item) {
                                        var translate = position
                                            ...
                                            : item[1]
                                        animations[this.options.animation[ev]]
                                            .positions &&
                                            (translate = translate.replace(
                                                '%V',
                                                animations[
                                                    this.options.animation[ev]
                                                ].positions[position][item[0]],
                                            ))
                                        keyframe_css +=
                                            item[0] +
                                            ' {transform:' +
                                ...
                                function(index, ev) {
                                    ...
                                    animations[this.options.animation[ev]]
                                        ...
                                        ? jQuery.each(
                                              ...
                                              function(index2, position) {
                                                  this._animationCSS += generateKeyframeCSS(
                                                      ev,
                                                      position,
                                                  )
                                              }.bind(this),
                        ...
                        this._animate = function(ev) {
                            ...
                            var animationDirection =
                                this.options.animation[ev + 'Direction'] ||
                                (this.align != 'center'
                                    ? this.align
                                    : this.options.attributes.x)
                            this.flipped &&
                                this._getXY(animationDirection) ==
                                    this._getXY(this.align) &&
                                (animationDirection = this._getOpp(
                                    animationDirection,
                                ))
                            ...
                            var animationDuration =
                                parseFloat(
                                    this.wrapper.css('animation-duration'),
                                ) * 1000
                            ev == 'close' &&
                        ...
                        jQuery.type(this.options.preloadAudio) === 'string' &&
                            (this.options.preloadAudio = [
                                this.options.preloadAudio,
                            ])
                        jQuery.type(this.options.audio) === 'string' &&
                            (this.options.audio = { open: this.options.audio })
                        jQuery.type(this.options.volume) === 'number' &&
                            (this.options.volume = {
                        ...
                        if (
                            this.options.preloadAudio === true &&
                            this.options.audio
                        ) {
                            this.options.preloadAudio = []
                            jQuery.each(
                        ...
                        this.options.preloadAudio.length &&
                            jQuery.each(this.options.preloadAudio, function(
                                index,
                                url,
                            ) {
                                var audio = new Audio()
                        ...
                        elements &&
                            ...
                            jQuery.each(
                                ...
                                function(index, el) {
                                    ...
                                    this.attachedElements = jQuery.grep(
                                        this.attachedElements,
                                        function(value) {
                                            return value != el[0]
                                        },
                    ...
                    jBox.prototype.setTitle = function(
                        ...
                        if (!this.title) {
                            ...
                            this.title = jQuery('<div/>').appendTo(
                                this.titleContainer,
                            )
                            if (
                                this.options.closeButton == 'title' ||
                                (this.options.closeButton === true &&
                                    !this.options.overlay)
                            ) {
                        ...
                        this.wrapper[title ? 'addClass' : 'removeClass'](
                            'jBox-hasTitle',
                        )
                        ...
                        wrapperWidth != this.wrapper.outerWidth() &&
                            this._setTitleWidth()
                    ...
                    jBox.prototype.setContent = function(
                        content,
                        ignore_positioning,
                    ) {
                    ...
                    jBox.prototype.position = function(options) {
                        ...
                        // Get the target
                        this.target =
                            options.target || this.target || jQuery(window)

                        // Make sure target is a jQuery element
                        !(
                            this.target instanceof jQuery ||
                            this.target == 'mouse'
                        ...
                        this.content.css({
                            ...
                            minHeight: this._getInt(
                                options.minHeight,
                                'height',
                            ),
                            maxWidth: this._getInt(options.maxWidth, 'width'),
                            maxHeight: this._getInt(
                                options.maxHeight,
                                'height',
                            ),
                        })
                        ...
                        windowDimensions.bottom =
                            windowDimensions.top + windowDimensions.y
                        windowDimensions.right =
                            windowDimensions.left + windowDimensions.x
                        ...
                        if (
                            ...
                            targetOffset.top =
                                targetOffset.top - jQuery(window).scrollTop()
                            targetOffset.left =
                                targetOffset.left - jQuery(window).scrollLeft()
                        }
                        ...
                        var targetDimensions = {
                            ...
                            top:
                                this.target == 'mouse' && options.mouseTarget
                                    ? options.mouseTarget.top
                                    : targetOffset
                                    ? targetOffset.top
                                    : 0,
                            left:
                                this.target == 'mouse' && options.mouseTarget
                                    ? options.mouseTarget.left
                                    : targetOffset
                                    ? targetOffset.left
                                    : 0,
                        }
                        ...
                        var availableSpace = {
                            x:
                                windowDimensions.x -
                                options.adjustDistance.left -
                                options.adjustDistance.right, // TODO: substract position.x when they are numbers
                            y:
                                windowDimensions.y -
                                options.adjustDistance.top -
                                options.adjustDistance.bottom, // TODO: substract position.x when they are numbers
                            left: !outside
                                ? 0
                        ...
                        var jBoxOutsidePosition = {
                            x:
                                (options.outside == 'x' ||
                                    options.outside == 'xy') &&
                                jQuery.type(options.position.x) != 'number'
                                    ? options.position.x
                                    : null,
                            y:
                                (options.outside == 'y' ||
                                    options.outside == 'xy') &&
                                jQuery.type(options.position.y) != 'number'
                                    ? options.position.y
                                    : null,
                        }
                        var flip = { x: false, y: false }
                        jBoxOutsidePosition.x &&
                            jBoxDimensions.x >
                                availableSpace[jBoxOutsidePosition.x] &&
                            availableSpace[
                                this._getOpp(jBoxOutsidePosition.x)
                            ] > availableSpace[jBoxOutsidePosition.x] &&
                            (jBoxOutsidePosition.x = this._getOpp(
                                jBoxOutsidePosition.x,
                            )) &&
                            (flip.x = true)
                        jBoxOutsidePosition.y &&
                            jBoxDimensions.y >
                                availableSpace[jBoxOutsidePosition.y] &&
                            availableSpace[
                                this._getOpp(jBoxOutsidePosition.y)
                            ] > availableSpace[jBoxOutsidePosition.y] &&
                            (jBoxOutsidePosition.y = this._getOpp(
                                jBoxOutsidePosition.y,
                            )) &&
                            (flip.y = true)
                            ...
                            var adjustResponsiveWidth = function() {
                                if (
                                    ...
                                    this.content.css({
                                        width:
                                            contentWidth >
                                            this.options.responsiveMinWidth
                                                ? contentWidth
                                                : null,
                                        minWidth:
                                            contentWidth <
                            ...
                            var adjustResponsiveHeight = function() {
                                if (
                                    ...
                                    this.content.css({
                                        height:
                                            contentHeight >
                                            this.options.responsiveMinHeight
                                                ? contentHeight
                                                : null,
                                    })
                                    this._setTitleWidth()
                        ...
                        var setPosition = function(p) {
                            ...
                            if (options.position[p] == 'center') {
                                pos[a] += Math.ceil(
                                    (targetDimensions[p] - jBoxDimensions[p]) /
                                        2,
                                )
                                ...
                                this.target != 'mouse' &&
                                    ...
                                    this.target[0] == jQuery(window)[0] &&
                                    (pos[a] +=
                                        (options.adjustDistance[a] -
                                            options.adjustDistance[
                                                this._getOpp(a)
                                            ]) *
                                        0.5)
                                return
                        ...
                        if (
                            ...
                            pos[
                                this._getTL(this._getOpp(this.pointer.xy))
                            ] += adjustWrapper
                        }
                        ...
                        if (options.adjustPosition) {
                            ...
                            var outYT =
                                    ...
                                    pos.top - (options.adjustDistance.top || 0),
                                outXR =
                                    windowDimensions.right <
                                    pos.left +
                                        jBoxDimensions.x +
                                        (options.adjustDistance.right || 0),
                                outYB =
                                    windowDimensions.bottom <
                                    pos.top +
                                        jBoxDimensions.y +
                                        (options.adjustDistance.bottom || 0),
                                outXL =
                                    windowDimensions.left >
                                    pos.left -
                                        (options.adjustDistance.left || 0),
                            ...
                            if (out) {
                                if (
                                    (this.type == 'Modal' ||
                                        this.type == 'Confirm') &&
                                    jQuery.type(this.options.position.x) ==
                                        'number' &&
                                    jQuery.type(this.options.position.y) ==
                                        'number'
                                ) {
                                    var diffX = 0,
                                        diffY = 0
                                    if (this.options.holdPosition) {
                                        ...
                                        this.options.position.x = Math.max(
                                            windowDimensions.top,
                                            this.options.position.x + diffX,
                                        )
                                        this.options.position.y = Math.max(
                                            windowDimensions.left,
                                            this.options.position.y + diffY,
                                        )
                                ...
                                if (
                                    options.adjustPosition === true ||
                                    options.adjustPosition === 'flip'
                                ) {
                                ...
                                if (
                                    ...
                                    var spaceDiff =
                                        outMove == this._getTL(outMove)
                                            ? windowDimensions[
                                              ...
                                              pos[this._getTL(outMove)] +
                                              options.adjustDistance[outMove]
                                            : (windowDimensions[
                                                  this._getOpp(
                                                      this._getTL(outMove),
                                                  )
                                    ...
                                    if (
                                        ...
                                        pos[this._getTL(outMove)] - spaceDiff <
                                            windowDimensions[
                                                this._getTL(outMove)
                                            ] +
                                                options.adjustDistance[
                    ...
                    jBox.prototype.unscroll = function(elements) {
                        ...
                        this.get = function(id) {
                            return window.unscrollStore
                                ? window.unscrollStore[id]
                                : null
                        }
                        ...
                        if (this.pageHasScrollbar()) {
                            ...
                            for (var i = 0; i < elements.length; i++) {
                                var elementsDOM = document.querySelectorAll(
                                    elements[i][0],
                                )
                                for (var j = 0; j < elementsDOM.length; j++) {
                                    if (
                                        elementsDOM[j].getAttribute(
                                            'data-unscroll',
                                        )
                                    ) {
                                        return
                                    ...
                                    var computedStyle = computedStyles.getPropertyValue(
                                        attribute,
                                    )
                                    elementsDOM[j].setAttribute(
                                        'data-unscroll',
                                        attribute,
                                    )
                                    if (!computedStyle) {
                    ...
                    jBox.prototype.unscroll.reset = function() {
                        ...
                        for (var i = 0; i < elements.length; i++) {
                            var attribute = elements[i].getAttribute(
                                'data-unscroll',
                            )
                            ...
                            jQuery('body').on(
                                ...
                                function(ev) {
                                    if (
                                        this.blockBodyClick ||
                                        (this.options.closeOnClick == 'body' &&
                                            (ev.target == this.wrapper[0] ||
                                                this.wrapper.has(ev.target)
                                                    .length))
                                    )
                                        return
                                    this.close({ ignoreDelay: true })
                        ...
                        var open = function() {
                            ...
                            this.source &&
                                ...
                                (this.source.data('jBox-getContent')
                                    ...
                                    : this.options.getContent == 'html'
                                    ? this.setContent(this.source.html(), true)
                                    : null)
                            ...
                            if (
                                (this.options.ajax &&
                                    (this.options.ajax.url ||
                                        (this.source &&
                                            this.source.attr(
                                                this.options.ajax.getURL,
                                            ))) &&
                                    (!this.ajaxLoaded ||
                                        this.options.ajax.reload)) ||
                                (options.ajax &&
                                    (options.ajax.url || options.ajax.data))
                            ) {
                                // Send the content from stored data if there is any, otherwise load new data
                                this.options.ajax.reload != 'strict' &&
                                this.source &&
                                ...
                                !(
                                    ...
                                    : this.ajax(options.ajax || null, true)
                            }

                            // Set position
                            ;(!this.positionedOnOpen ||
                                this.options.repositionOnOpen) &&
                                                ...
                                                setTimeout(
                                                    function() {
                                                        this
                                                            ...
                                                            this.position() &&
                                                            (this.positionOnFadeComplete = false)
                                                    }.bind(this),
                                                    10,
                                                )
                                            }.bind(this),
                    ...
                    jBox.prototype.close = function(options) {
                        ...
                        var close = function() {
                            ...
                            if (this.isOpen) {
                                ...
                                if (this.options.blockScroll) {
                                    if (this.options.blockScrollAdjust) {
                                        jBox.blockScrollScopes = jBox.blockScrollScopes
                                            ? --jBox.blockScrollScopes
                                            : 0
                                        !jBox.blockScrollScopes &&
                                            this.unscroll.reset()
                        ...
                        if (
                            ...
                            (this.options.delayOnHover ||
                                this.options.showCountdown) &&
                            this.options.delayClose > 10
                        ) {
                            var self = this
                            ...
                            if (this.options.showCountdown && !this.inner) {
                                var outer = jQuery(
                                    '<div class="jBox-countdown" />',
                                )
                                this.inner = jQuery(
                                    '<div class="jBox-countdown-inner" />',
                                )
                    ...
                    jBox.prototype.ajax = function(options, opening) {
                        ...
                        var success =
                            ...
                            function() {}
                        var error =
                            options.error || sysOptions.error || function() {}
                        ...
                        userOptions.beforeSend = function(xhr) {
                            // jBox is loading
                            userOptions.loadingClass &&
                                this.wrapper.addClass(
                                    userOptions.loadingClass === true
                                        ? 'jBox-loading'
                                        : userOptions.loadingClass,
                                )
                            ...
                            userOptions.spinner &&
                                (this.spinnerDelay = setTimeout(
                                    function() {
                                        ...
                                        userOptions.spinnerReposition &&
                                            (opening
                                                ? (this.positionOnFadeComplete = true)
                                                : this.position())

                                        // Add spinner to container
                                        this.spinner = jQuery(
                                            userOptions.spinner !== true
                                                ? userOptions.spinner
                        ...
                        userOptions.success = function(response) {
                            // Set content
                            userOptions.setContent &&
                                this.setContent(response, true) &&
                                (opening
                                    ? (this.positionOnFadeComplete = true)
                                    : this.position())
                            ...
                            userOptions.setContent &&
                                this.source &&
                                this.source.data('jBox-ajax-data', response)
                    ...
                    jBox.prototype.audio = function(url, volume) {
                        ...
                        if (!jBox._audio[url]) {
                            ...
                            jQuery('<source/>', { src: url + '.mp3' }).appendTo(
                                audio,
                            )
                            jQuery('<source/>', { src: url + '.ogg' }).appendTo(
                                audio,
                            )
                        ...
                        // Set volume
                        jBox._audio[url].volume = Math.min(
                            (volume != undefined ? volume : 100) / 100,
                            1,
                        )
                    ...
                    jBox.prototype.animate = function(animation, options) {
                        ...
                        !options.element.data('jBox-animating-id') &&
                            options.element.data(
                                'jBox-animating-id',
                                jBox._getUniqueElementID(),
                            )
                        ...
                        if (options.element.data('jBox-animating')) {
                            options.element
                                .removeClass(
                                    options.element.data('jBox-animating'),
                                )
                        ...
                        // Animate the element
                        options.element
                            .addClass('jBox-animated-' + animation)
                            .data(
                                'jBox-animating',
                                'jBox-animated-' + animation,
                            )
                        this.animationTimeout[
                            options.element.data('jBox-animating-id')
                        ] = setTimeout(function() {
                ...
                function jBoxConfirmWrapper(jBox, jQuery) {
                    new jBox.plugin('Confirm', {
                        ...
                        _onCreated: function() {
                            ...
                            jQuery(
                                '<div class="jBox-Confirm-button jBox-Confirm-button-cancel"/>',
                            )
                            ...
                            this.submitButton = jQuery(
                                '<div class="jBox-Confirm-button jBox-Confirm-button-submit"/>',
                            )
                    ...
                    new jBox.plugin('Image', {
                        ...
                        _onInit: function() {
                            ...
                            this.initImage = function(item) {
                                ...
                                if (
                                    this.options.mobileImageAttr &&
                                    this.options.mobileImageBreakpoint &&
                                    item.attr(this.options.mobileImageAttr)
                                ) {
                                    if (
                                        jQuery(window).width() <=
                                        this.options.mobileImageBreakpoint
                                ...
                                var gallery =
                                    item.attr(this.options.gallery) || 'default'
                                !this.images[gallery] &&
                                    (this.images[gallery] = [])
                                this.images[gallery].push({
                                    src: src,
                                    label:
                                        item.attr(this.options.imageLabel) ||
                                        '',
                                    downloadUrl:
                                        this.options.downloadButtonUrl &&
                                        item.attr(
                                            this.options.downloadButtonUrl,
                                        )
                                            ? item.attr(
                            ...
                            var appendImage = function(
                                ...
                                show &&
                                    image.animate(
                                        { opacity: 1 },
                                        instant ? 0 : this.options.imageFade,
                                    )
                            ...
                            var showLabel = function(gallery, id) {
                                jQuery('.jBox-image-label.active').removeClass(
                                    'active expanded',
                                )
                                jQuery(
                                    '#jBox-image-label-' + gallery + '-' + id,
                                ).addClass('active')
                            }
                            ...
                            var loadImage = function(
                                ...
                                var imageContainer = appendImage(
                                    gallery,
                                    id,
                                    show,
                                    instant,
                                ...
                                jQuery(
                                    ...
                                    function() {
                                        ...
                                        tmpImg.onload = function() {
                                            imageContainer.removeClass(
                                                'jBox-image-loading',
                                            )
                                            imageContainer.css({
                                                backgroundImage:
                                                    'url("' +
                                                    this.images[gallery][id]
                                                        .src +
                                                    '")',
                                            })
                                        }.bind(this)
                                        ...
                                        tmpImg.src = this.images[gallery][
                                            id
                                        ].src
                                    }.bind(this),
                                )
                            ...
                            this.showImage = function(img) {
                                ...
                                if (img != 'open') {
                                    ...
                                    var id =
                                        ...
                                        (1 * (img == 'prev') ? -1 : 1)
                                    id =
                                        id > this.images[gallery].length - 1
                                            ? 0
                                            : id < 0
                                            ? this.images[gallery].length - 1
                                            : id
                                    ...
                                    if (this.source) {
                                        var gallery = this.source.data(
                                            'jBox-image-gallery',
                                        )
                                        var id = this.source.data(
                                            'jBox-image-id',
                                        )
                                    ...
                                    jQuery(
                                        '.jBox-image-pointer-prev, .jBox-image-pointer-next',
                                    ).css({
                                        display:
                                            this.images[gallery].length > 1
                                                ? 'block'
                                ...
                                if (this.imageCounter) {
                                    if (this.images[gallery].length > 1) {
                                        this.wrapper.addClass(
                                            'jBox-image-has-counter',
                                        )
                                        this.imageCounter
                                            .find('.jBox-image-counter-all')
                                            .html(this.images[gallery].length)
                                        this.imageCounter
                                            .find('.jBox-image-counter-current')
                                            .html(id + 1)
                                    } else {
                                        this.wrapper.removeClass(
                                            'jBox-image-has-counter',
                        ...
                        _onCreated: function() {
                            ...
                            if (this.options.downloadButton) {
                                this.downloadButton = jQuery('<div/>', {
                                    class: 'jBox-image-download-button-wrapper',
                                })
                                    .appendTo(this.wrapper)
                                    .append(
                                        this.options.downloadButtonText
                                            ? jQuery('<div/>', {
                                                  class:
                                    ...
                                    .on(
                                        ...
                                        function() {
                                            if (
                                                this.images[
                                                    this.currentImage.gallery
                                                ][this.currentImage.id]
                                                    .downloadUrl
                                            ) {
                                                var currentImageUrl = this
                                                    .images[
                                                    this.currentImage.gallery
                                                ][this.currentImage.id]
                                                    .downloadUrl
                                            } else {
                                                var currentImage = this.wrapper.find(
                                                    '.jBox-image-' +
                                                        this.currentImage
                                                            .gallery +
                                                        '-current',
                                                ...
                                                var currentImageStyle =
                                                    currentImage[0].style
                                                        .backgroundImage
                                                var currentImageUrl = currentImageStyle
                                                    .slice(4, -1)
                                                    .replace(/["']/g, '')
                                            }
                            ...
                            if (this.options.imageCounter) {
                                ...
                                this.imageCounter
                                    ...
                                    .append(
                                        jQuery('<span/>').html(
                                            this.options.imageCounterSeparator,
                                        ),
                                    )
                                    .append(
                                        jQuery('<span/>', {
                ...
                function jBoxNoticeWrapper(jBox, jQuery) {
                    new jBox.plugin('Notice', {
                        ...
                        attributes: {
                            // Defines where the notice will pop up
                            x: 'right', // 'left' or 'right'
                            y: 'top', // 'top' or 'bottom'
                        },
                        position: {
                            // Defines the distance to the viewport boundary
                            x: 15,
                            y: 15,
                        },
                        responsivePositions: {
                            ...
                            500: {
                                // The key defines the maximum width of the viewport, the values will replace the default position options
                        ...
                        _onInit: function() {
                            ...
                            this.defaultNoticePosition = jQuery.extend(
                                {},
                            ...
                            this._adjustNoticePositon = function() {
                                ...
                                this.options.position = jQuery.extend(
                                    {},
                                    this.defaultNoticePosition,
                                )
                            ...
                            this.options.content instanceof jQuery &&
                        ...
                        _onCreated: function() {
                            // Add color class
                            this.wrapper.addClass(
                                'jBox-Notice-color jBox-Notice-' +
                                    (this.options.color || 'gray'),
                            )
                        ...
                        _onPosition: function() {
                            var stacks = {}
                            jQuery.each(jQuery('.jBox-Notice'), function(
                                index,
                                el,
                            ) {
                                el = jQuery(el)
                    ...
                    jQuery.each(
                        {
                            ...
                            contents: function(elem) {
                                if (
                                    typeof elem.contentDocument !== 'undefined'
                                ) {
  ...
  \*****************************/
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                __webpack_require__(/*! ./share */ './resources/js/share.js')
  ...
  \***********************************/
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                window.jBox = __webpack_require__(
                    /*! jbox */ './node_modules/jbox/dist/jBox.all.js',
                )
  ...
  \*******************************/
            ...
            /***/ function(module, exports) {
                window.observeShareButtons = function() {
  ...
  \*************************************************************/
            ...
            /***/ function(module, exports, __webpack_require__) {
                __webpack_require__(
                    /*! /Users/antoniocarlos/code/area17/a17-demo/resources/js/app.js */ './resources/js/app.js',
                )
                module.exports = __webpack_require__(
                    /*! /Users/antoniocarlos/code/area17/a17-demo/resources/sass/app.scss */ './resources/sass/app.scss',
                )
